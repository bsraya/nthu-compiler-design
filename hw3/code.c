...
char * install_symbol(char *s) {
  if (cur_counter >= MAX_TABLE_SIZE) perror("Symbol Table Full");
  else {
...
// return an integer as an index of the symbol table
...
// Pop up symbols of the given scope from the symbol table upon the exiting a scope
...
// setup parameter scope and offset
...
// generate house-keeping work at the beginning of the function
...
// generate house-keeping work at the end of a function
