...
%type <stringval> assignment_expression_without_function
...
%type <stringval> logical_or_expression_without_function
%type <stringval> logical_and_expression_without_function
%type <stringval> and_expression_without_function
%type <stringval> equality_expression_without_function
%type <stringval> relational_expression_without_function
%type <stringval> additive_expression_without_function
%type <stringval> multiplicative_expression_without_function
%type <stringval> unary_expression_without_function
%type <stringval> postfix_expression_without_function
%type <stringval> primary_expression_without_function
...
assignment_expression_without_function: 
		...
		unary_expression_without_function ASSIGN_EQUAL assignment_expression_without_function
		;
...
logical_and_expression_without_function:
		...
		logical_and_expression_without_function LOGICAL_AND and_expression_without_function
		;
...
relational_expression_without_function:
		...
		relational_expression_without_function GREATER_EQUAL_THAN additive_expression_without_function |
		relational_expression_without_function LESS_THAN additive_expression_without_function |
		relational_expression_without_function LESS_EQUAL_THAN additive_expression_without_function
		;
...
postfix_expression_without_function:
		primary_expression_without_function |
		postfix_expression_without_function LEFT_SQUARE_BRACKET TOKEN_INTEGER RIGHT_SQUARE_BRACKET |
		postfix_expression_without_function DOT TOKEN_IDENTIFIER |
		postfix_expression_without_function INCREMENT |
		postfix_expression_without_function DECREMENT 
		; 
